...
//題目 : https://e-tutor.itsa.org.tw/e-Tutor/mod/programming/view.php?id=30787

boolean checkDiagonal(int map[3][3]){
    return (map[0][0] == map[1][1] && map[1][1] == map[2][2]) || (map[2][0] == map[1][1] && map[1][1] == map[0][2]);
}
boolean checkVertical(int map[3][3]){
...
boolean checkHorizontal(int map[3][3]){
...
int main(){  
    ...
    boolean succ = checkDiagonal(map) || checkVertical(map) || checkHorizontal(map);
    printf("%s\n", succ ? "True" : "False");
    return 0;  
}  
