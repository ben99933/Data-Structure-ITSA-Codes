...
//題目 : https://e-tutor.itsa.org.tw/e-Tutor/mod/programming/view.php?id=15139
...
int main(){ 
    ...
    arrayList_add(list, newInt(1));
    arrayList_add(list, newInt(6));
    arrayList_add(list, newInt(9));
    arrayList_add(list, newInt(23));
    arrayList_add(list, newInt(56));
    arrayList_add(list, newInt(95));
    arrayList_add(list, newInt(n));

    arrayList_sort(list,cmp);
