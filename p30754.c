...
//題目 : https://e-tutor.itsa.org.tw/e-Tutor/mod/programming/view.php?id=30754
/**
 * 給數字 輸出月份
 */

//if a<= num and num <= b
boolean func(int a, int b, int num){
    return a <= num && num <= b;
}
...
int main(){
    ...
    while(scanf("%d", &month) != EOF){
        if(func(3,5, month))printf("Spring\n");
        else if(func(6,8,month))printf("Summer\n");
        else if(func(9, 11, month))printf("Autumn\n");
        else printf("Winter\n");
    }
    return 0;
}
